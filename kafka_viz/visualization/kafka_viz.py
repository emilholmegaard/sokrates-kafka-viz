...
class KafkaViz(BaseGenerator):
    ...
    def generate_react_app(self, visualization_data, output_dir):
        ...
        with open(os.path.join(output_dir, "visualization-data.json"), "w") as f:
            # Add to global scope for the React app
            f.write("window.visualizationData = ")
            json.dump(visualization_data, f, indent=2)
            f.write(";")

        # Copy template files from resources
        try:
            # Get template content
            index_html = load_template("react", "index.html")
...
<body>
    ...
    <script src="app.js" type="text/babel"></script>
            ...
            # Create CSS - Using default hardcoded CSS
            css = """body {
...
.legend-label {
    font-size: 12px;
            ...
            # Create React app with D3.js - Using default from resources
            # This is just a fallback; in production, load from template files
