...
def test_service_level_analysis_basic():
    ...
    assert list(dep_analyzer.get_dependencies("producer-service")) == ["consumer-service"]
    assert list(dep_analyzer.get_dependents("consumer-service")) == ["producer-service"]


def test_service_level_analysis_with_multiple_topics():
...
def test_service_level_analysis_cycle_detection():
